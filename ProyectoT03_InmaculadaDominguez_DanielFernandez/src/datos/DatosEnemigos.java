...
public class DatosEnemigos {
	...
	public static Enemigo e2 = new Enemigo("bbbbbbb",ControllerEnemigo.generarVidaEnemigos(),10,3,6,true,1);
	public static Enemigo e3 = new Enemigo("ccccccc",ControllerEnemigo.generarVidaEnemigos(),15,3,9,true,2);
